...
function Bus({ bus }) {
  ...
  // Retrieve the token and isAdmin from localStorage
  ...
  return (
    <div className="max-w-full bg-white flex flex-col rounded overflow-hidden shadow-lg">
      ...
      {/* AC/Non-AC Information */}
      <div className="mt-2 flex sm:flex-row mx-6 sm:justify-between flex-wrap">
        <div className="flex flex-col p-2">
          <p className="font-bold">AC/Non-AC</p>
          <p className="text-gray-500">{bus.ac}</p>
        </div>
      </div>
      ...
      <div className="mt-4 bg-gray-100 flex flex-row flex-wrap md:flex-nowrap justify-between items-baseline">
        ...
        <div className="md:border-l-2 mx-6 md:border-dotted flex flex-row py-4 mr-6 flex-wrap">
          ...
          {/* Conditionally hide button for admins */}
          {!isAdmin && (
            <button
